          ...
          <div className="container mx-auto px-4 h-full">
            <div className="flex items-center justify-between h-full">
              ...
              <div className="flex items-center gap-2 sm:gap-4">
                ...
                >
                  <div className="text-primary">
                    <svg className="h-6 w-6 sm:h-7 sm:w-7" fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <h2 className="hidden sm:block text-lg sm:text-xl font-bold tracking-tight">Chat2PDF</h2>
                </button>

                {/* New button - only on tablet */}
                <button 
                  onClick={handleNewChat}
                  className="hidden sm:flex lg:hidden items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-all duration-200"
                >
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                {/* Mobile Tab Switcher */}
                {session && (
                  <div className="lg:hidden flex items-center gap-0.5 sm:gap-1 bg-gray-100 p-0.5 sm:p-1 rounded-lg">
                    <button
                ...
                {session && (
                  <button
                    onClick={handlePrint}
                    className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-primary text-white text-xs sm:text-sm font-semibold rounded-lg hover:opacity-90 transition-opacity shadow-sm min-w-[44px] min-h-[44px]"
                  >
